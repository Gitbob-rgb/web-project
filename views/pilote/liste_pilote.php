        ...
        <div class="pagination">
            <?php if (isset($pagination) && $pagination['pages'] > 1): ?>
                <div class="pagination-info" style="text-align: center; margin-bottom: 1rem;">
                    ...
                    sur <?php echo $pagination['total'] ?> pilotes
                </div>
                
                <?php if ($pagination['current'] > 1): ?>
                    <a href="index.php?page=liste_pilote&page_num=1<?php echo isset($_GET['search']) ? '&search=' . htmlspecialchars($_GET['search']) : ''; ?>" title="Première page">&laquo;</a>
                    <a href="index.php?page=liste_pilote&page_num=<?php echo ($pagination['current'] - 1); ?><?php echo isset($_GET['search']) ? '&search=' . htmlspecialchars($_GET['search']) : ''; ?>" title="Page précédente">&#8249;</a>
                <?php endif; ?>
                
                <?php for ($i = max(1, $pagination['current'] - 2); $i <= min($pagination['pages'], $pagination['current'] + 2); $i++): ?>
                    <a href="index.php?page=liste_pilote&page_num=<?php echo $i; ?><?php echo isset($_GET['search']) ? '&search=' . htmlspecialchars($_GET['search']) : ''; ?>" 
                ...
                <?php if ($pagination['current'] < $pagination['pages']): ?>
                    <a href="index.php?page=liste_pilote&page_num=<?php echo ($pagination['current'] + 1); ?><?php echo isset($_GET['search']) ? '&search=' . htmlspecialchars($_GET['search']) : ''; ?>" title="Page suivante">&#8250;</a>
                    <a href="index.php?page=liste_pilote&page_num=<?php echo $pagination['pages']; ?><?php echo isset($_GET['search']) ? '&search=' . htmlspecialchars($_GET['search']) : ''; ?>" title="Dernière page">&raquo;</a>
                <?php endif; ?>
            <?php endif; ?>
        </div>
    </div>
