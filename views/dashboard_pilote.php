...
<head>
    ...
    <title>Tableau de bord Pilote - Plateforme de Stages</title>
...
<body>
    <div class="dashboard-container">
        ...
        <div class="user-info">
            ...
            <div class="details">
                <h3>
                    ...
                    <span class="role-badge role-pilote">
                        Pilote
                    </span>
                </h3>
        ...
        <div class="alert alert-info">
            <strong>Bienvenue dans votre espace pilote!</strong> Gérez les offres de stage, les entreprises et les étudiants que vous suivez.
        </div>
        ...
        <div class="modules-container" id="modules-container">
            ...
            <div class="module">
                ...
                <div class="module-links">
                    ...
                    <a href="index.php?page=ajouter_offre" class="module-link">Ajouter une offre</a>
                </div>
            </div>
            ...
            <div class="module">
                ...
                <div class="module-links">
                    ...
                    <a href="index.php?page=ajouter_entreprise" class="module-link">Ajouter une entreprise</a>
                </div>
            </div>
            ...
            <div class="module">
                ...
                <div class="module-links">
                    ...
                    <a href="index.php?page=ajouter_etudiant" class="module-link">Ajouter un étudiant</a>
                </div>
            </div>
